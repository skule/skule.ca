...
<div class="columns is-multiline">
    <div class="column is-12">
        ...
        <p>Project Directors each manage a particular service or initiative, from managing a café to teaching high school students about engineering. Many of them form committees or teams open to anyone at Skule™ to achieve their goals for the year. They are elected by the outgoing EngSoc Council members near the end of their terms.</p>
    </div>
    ...
    <div class="column"> <!-- Alumni Outreach -->
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-success">Alumni Outreach Director** Charu Tyagi <small class="has-text-success">Overseen by the President</small></p>
                        <p>The Alumni Outreach Director develops the relationship between engineering alumni and current engineering students. They promote Skule™ activities and development to former students and work with other student groups and with the faculty to increase alumni engagement.</p> <a class="button is-small is-success" href="mailto:alumnioutreach@skule.ca">Email</a>
                    </div>
                </div>
            </article>
        </div> <!-- Archivist -->
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-success">Archivist** Steven Li <small class="has-text-success">Overseen by the President</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-warning">Cannon Editor-in-Chief** Navin Vanderwert <small class="has-text-warning">Overseen by VP Communications</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-info">Cannonball Director** Sophia McGregor <small class="has-text-info">Overseen by VP Finance</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-primary">Community Outreach Director** Jane Hwang <small class="has-text-primary">Overseen by VP Student Life</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-danger">Commuter Student Director** Celin Begeshev <small class="has-text-danger">Overseen by the VP Academic</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-warning"> Computer Systems Administrator** Arthur Akbulatov <small class="has-text-warning">Overseen by VP Communications</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-primary">Design Team Association Director** Josea Tarulli <small class="has-text-primary">Overseen by VP Student Life</small>
                        <p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-success">Environmental Sustainability Director**Michal Korteweg Davis <small class="has-text-success">Overseen by the President</small></p>
                        <p>The Environmental Sustainability Director assesses the environmental impact of EngSoc's operations, with the goal of improving EngSoc's environmental sustainability, in collaboration with students and other groups on campus.</p> <a class="button is-small is-success" href="mailto:sustainability@g.skule.ca">Email</a> <a class="button is-small is-success" href="https://skule.ca/wp-content/uploads/2022/EnvironmentalSustainabilityAssessment2022-Final.pdf">Report</a>
                    </div>
                </div>
            </article>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-success">Equity and Inclusivity Director**<small></small> Boran Ocak <small class="has-text-success">Overseen by the President</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-success">External Relations Director** Tina Sokhanvar <small class="has-text-success">Overseen by the President</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-info">Gradball Director** Kayla Carnide<small class="has-text-info">Overseen by VP Finance</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-danger">Hi-Skule™ Liaison** Prarthona Paul <small class="has-text-danger">Overseen by VP Academic</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-danger">Mental Wellness Director** Tegbir Singh Chandhok <small class="has-text-danger">Overseen by VP Academic</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p>**Ombudsperson** Michelle DeLoyde <small>Overseen by the Speaker</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-success">Orientation Chair** Joanna Roy <small class="has-text-success">Overseen by the President </small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-success">Skule™150 Director** Richard Naso <small class="has-text-success">Overseen by the President </small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-primary">Skule™ Kup Director** Isabella Gallicchio <small class="has-text-primary">Overseen by VP Student Life</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-primary">Skule™ Photography Director** Ethan Chen <small class="has-text-primary">Overseen by VP Student Life</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-warning">Skulebook Editor** Carl Joseph Ancheta <small class="has-text-warning">Overseen by VP Communications</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-warning">Social Media Coordinator** Iva Guo <small class="has-text-warning">Overseen by VP Communications</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-warning">Toike Oike Editor-in-Chief** Ben Gloade <small class="has-text-warning">Overseen by VP Communications</small></p>
        ...
        <div class="box">
            <article class="media">
                <div class="media-content">
                    <div class="content">
                        <p><strong class="has-text-danger">UTEK Director** Beliz Zorbozan <small class="has-text-danger">Overseen by VP Academic</small></p>
