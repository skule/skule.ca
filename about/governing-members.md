...
|Position|Officer|
|-|-|
|President|<img src="/profiles/IMG_6613.PNG" alt="1" style="max-width: 20%; flex: 1 1 300px; min-width: 220px; height: auto;"> [{{ site.data.council.officer.president }}](mailto:president@skule.ca)|
