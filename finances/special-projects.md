...
-	EngSoc Project Directorships and Associated Entities;
-	EngSoc Affiliated Trial Status Club;
-	EngSoc Affiliated Full Status Club (that is not a Levy Group).

The following groups are not eligible:
-	Levy Groups;
-	Non-EngSoc Affiliated Entities;
-	Discipline Clubs.
...
-	Quotes or primary-source evidence for each budgeted expense;
